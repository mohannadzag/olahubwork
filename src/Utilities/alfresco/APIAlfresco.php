...
use OlaHub\UserPortal\Libraries\cmisService;
...
class APIAlfresco {
     ...
     * @param string $id
     */
    public function resizeImage($id, $w, $h) {
        $file = $this->getObjectById($id);
        $name = $file->properties['cmis:name'];
        $mime = $file->properties['cmis:contentStreamMimeType'];
        $mime = str_replace("\t", '', $mime);
...
//        }
    ...
    private function extractSpecialCharacters($word) {
        ...
        $word = str_replace(
                array('á', 'à', 'ä', 'â', 'ª', 'Á', 'À', 'Â', 'Ä'), array('a', 'a', 'a', 'a', 'a', 'A', 'A', 'A', 'A'), $word
        );

        $word = str_replace(
                array('é', 'è', 'ë', 'ê', 'É', 'È', 'Ê', 'Ë'), array('e', 'e', 'e', 'e', 'E', 'E', 'E', 'E'), $word
        );

        $word = str_replace(
                array('í', 'ì', 'ï', 'î', 'Í', 'Ì', 'Ï', 'Î'), array('i', 'i', 'i', 'i', 'I', 'I', 'I', 'I'), $word
        );

        $word = str_replace(
                array('ó', 'ò', 'ö', 'ô', 'Ó', 'Ò', 'Ö', 'Ô'), array('o', 'o', 'o', 'o', 'O', 'O', 'O', 'O'), $word
        );

        $word = str_replace(
                array('ú', 'ù', 'ü', 'û', 'Ú', 'Ù', 'Û', 'Ü'), array('u', 'u', 'u', 'u', 'U', 'U', 'U', 'U'), $word
        );

        $word = str_replace(
                array('ñ', 'Ñ', 'ç', 'Ç'), array('n', 'N', 'c', 'C'), $word
        );
